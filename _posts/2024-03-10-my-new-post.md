...
![client & auth server](/assets/img/user_req.png)
...
The second message is sent to authenticate the user (we will discuss the process shortly).
 ...
 ![TGT](/assets/img/TGT%20&%20user_idetifier%20.png)
